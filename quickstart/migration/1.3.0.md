---
title: 1.3.0-rc2
caption: Migrating 1.2.4 → 1.3.0-rc2
category: quickstart
---
...
Published 28 Dec 2019 (`1.3.0-rc2`)
...
* `HttpResponse` deprecated and replaced with the same class from another package.
...
* `HttpStatement` has been introduced to support streaming in `execute()` functions lambda.
